...
if (minute >= 0 && minute < 15 ) {
    console.log(`${minute} минута попадает в первую четверть часа`);
} else if (minute >= 15 && minute < 30) {
    console.log(`${minute} минута попадает во вторую четверть часа`);
} else if (minute >= 30 && minute < 45) {
    console.log(`${minute} минута попадает в третью четверть часа`);
} else if (minute >= 45 && minute < 60) {
    console.log(`${minute} минута попадает в четвертую четверть часа`);
}
